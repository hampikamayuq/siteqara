...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = ["", "/dermatologia-clinica", "/cirurgia-dermatologica", "/cabelo", "/unhas", "/doencas-inflamatorias", "/dermatopediatria", "/dermatologia-estetica", "/equipe/dr-diego-galvez", "/equipe/dr-miguel-ceccarelli", "/equipe/dra-diana-stohmann", "/equipe/dra-manuela-pedretti", "/blog"];
