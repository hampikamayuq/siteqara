...
const schema={"@context":"https://schema.org","@type":"MedicalWebPage",name:"Cirurgia dermatológica",description:"Biópsias, remoção de lesões e tratamento cirúrgico do câncer da pele em Copacabana.",inLanguage:"pt-BR",url:"https://clinicaqara.com.br/cirurgiadermatologica",mainEntityOfPage:"https://clinicaqara.com.br/cirurgiadermatologica",about:{"@type":"MedicalSpecialty",name:"Cirurgia dermatológica"},author:{"@type":"Physician",name:"Dr. Diego Gálvez",medicalSpecialty:["Dermatology","Dermatologic Surgery"],identifier:["CRM-RJ 52-0112387-4","RQE 57517"],url:"https://clinicaqara.com.br/especialista",worksFor:{"@type":"MedicalClinic",name:"Clínica QARA",url:"https://clinicaqara.com.br"}}};

const faqSchema={"@context":"https://schema.org","@type":"FAQPage",mainEntity:faqs.map(([q,a])=>({"@type":"Question",name:q,acceptedAnswer:{"@type":"Answer",text:a}}))};

export default function SurgeryPage() {
  return <><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(schema)}}/><script type="application/ld+json" dangerouslySetInnerHTML={{__html:JSON.stringify(faqSchema)}}/><Header /><main id="conteudo">
    ...
    <section className="section shell specialty-faq"><div><p className="kicker">Perguntas frequentes</p><h2>Antes do procedimento.</h2></div><div className="practical-list">{faqs.map(([q,a])=><details key={q}><summary>{q}</summary><p>{a}</p></details>)}</div></section>
    <CtaBand />
  </main><Footer /></>;
}
