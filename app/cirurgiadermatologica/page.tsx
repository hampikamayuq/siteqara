...
export default function SurgeryPage() {
  return <><Header /><main>
    <section className="specialty-hero specialty-hero-dark"><div className="shell specialty-hero-grid"><div><p className="kicker light">Cirurgia dermatológica · Copacabana</p><h1>Precisão para diagnosticar, tratar e reconstruir.</h1><p className="lead">Procedimentos diagnósticos e cirúrgicos da pele, cabelos e unhas, do planejamento ao acompanhamento da cicatrização.</p><div className="actions"><a className="button button-light" href="https://wa.me/5521992189718?text=Olá%2C%20gostaria%20de%20agendar%20uma%20avaliação%20de%20cirurgia%20dermatológica.">Agendar avaliação</a><a className="button button-outline-light" href="#procedimentos">Ver procedimentos</a></div></div><div className="specialty-portrait"><img src="/images/dr-diego.webp" alt="Dr. Diego Gálvez, dermatologista e cirurgião dermatológico" width={1351} height={1672} fetchPriority="high" /></div></div></section>
