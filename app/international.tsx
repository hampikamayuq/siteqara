...
export const enContent: IntlContent = {
  ...
  teamText: "Four board-certified dermatologists (CRM/RQE), each dedicated to a specific area.",
  team: [
    ...
    ["Dra. Manuela Pedretti", "Inflammatory diseases and pediatric dermatology", ["DE", "PT"], "/images/dra-manuela.webp", "dra-manuela-pedretti"],
  ],
  ...
  faq: [
    ["Do the doctors speak English?", "Yes. Dr. Diego Gálvez and Dr. Miguel Ceccarelli provide care in English and Spanish. Dra. Diana Stohmann also attends in French and Dra. Manuela Pedretti in German. Tell us your language when booking and we will match you with the right specialist."],
...
export const esContent: IntlContent = {
  ...
  teamText: "Cuatro dermatólogos certificados (CRM/RQE), cada uno dedicado a un área específica.",
  team: [
    ...
    ["Dra. Manuela Pedretti", "Enfermedades inflamatorias y dermatología pediátrica", ["DE", "PT"], "/images/dra-manuela.webp", "dra-manuela-pedretti"],
  ],
